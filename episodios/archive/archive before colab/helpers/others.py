...
def _normalize_dt(dt):
    # accepts "2024-02-01 00:00:00", datetime, Timestamp, etc.
    ts = pd.to_datetime(dt, utc=True, errors="raise")  # force UTC if tz missing or present
    return ts.to_pydatetime()  # plain python datetime (works with timedelta + yfinance)
